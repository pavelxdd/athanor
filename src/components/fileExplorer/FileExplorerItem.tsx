...
import { areAllDescendantsSelected, areSomeDescendantsSelected } from '../../utils/fileSelection';
...
const FileExplorerItem: React.FC<FileExplorerItemProps> = React.memo(
  ({
    ...
    const hasSelectedDescendants = React.useMemo(
      () => areSomeDescendantsSelected(item, selectedFilesSet),
      [item, selectedFilesSet]
    );

    const allDescendantsSelected = React.useMemo(
      () => areAllDescendantsSelected(item, selectedFilesSet),
      [item, selectedFilesSet]
    );
    ...
    React.useEffect(() => {
      if (checkboxRef.current) {
        checkboxRef.current.indeterminate = hasSelectedDescendants && !allDescendantsSelected;
      }
